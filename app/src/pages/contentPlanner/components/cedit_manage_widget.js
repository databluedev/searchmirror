...
import { Para, Title, AppTooltip, AppButton } from "../../commonComponents/parts";
...
function CEditManageWidget(props) {
   ...
   return (
      <>
         <div>
            <div className="mngWdgt flex-[0_0_auto]">
         ...
         >
            <Fade in={open} {...(open ? { timeout: 750 } : { timeout: 1000 })}>
               <Box className="wd-modal-box mng-modal-box" sx={style}>
                  ...
                  <CEditOnboardInfo projectList={props.projectList} regionData={props.regionData} kwdSearchDetails={props.kwdSearchDetails} refetchContentPlans={props.refetchContentPlans} />
               </Box>
            </Fade>
         </Modal>
      </>
...
export default CEditManageWidget; 