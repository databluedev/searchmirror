...
from account.authorization.serializers import EmailSerializer, PasswordTokenSerializer, ResetTokenSerializer
from account.authorization.models import ResetPasswordToken, clear_expired, get_password_reset_token_expiry_time, \
    get_password_reset_lookup_field
from account.authorization.signals import reset_password_token_created, pre_password_reset, post_password_reset
...
class ResetPasswordRequestToken(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not active_user_found and not getattr(settings, 'DJANGO_REST_PASSWORDRESET_NO_INFORMATION_LEAKAGE', False):
            raise exceptions.ValidationError({
                'message': 
                    "E-mail id not found", 'status':"false",
            })
